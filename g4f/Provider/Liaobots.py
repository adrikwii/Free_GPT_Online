        ...
        **kwargs
        ...
        async with ClientSession(
            ...
            data = {
                ...
                "messages": messages,
                "key": "",
                "prompt": kwargs.get("system_message", "You are Free-GPT, a large language model trained by OpenAI. Follow the user's instructions carefully. Tu t'appelle Free-GPT"),
            }
            async with session.post(
