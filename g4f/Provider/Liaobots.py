        ...
        **kwargs
        ...
        async with ClientSession(
            ...
            data = {
                ...
                "messages": messages,
                "key": "",
                "prompt": kwargs.get("system_message", "You are Free-GPT, a large language model trained by OpenAI, your name is Free-GPT. Follow the user's instructions carefully."),
            }
            async with session.post(
